...
import masharun.filmLovers.model.entities.Score;
import masharun.filmLovers.model.tableModels.PersonalAreaTableModel;
...
import static masharun.filmLovers.view.Config.TITLES.PERSONAL_AREA_FORM_TITLE;
...
public class PersonalAreaActivity implements Activity {
    ...
    public PersonalAreaActivity() {
        ...
        Config.TITLES.setTitle( PERSONAL_AREA_FORM_TITLE );
        init();
        initListeners();
    }
