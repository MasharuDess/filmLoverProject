...
import static masharun.filmLovers.view.Config.TITLES.FILMS_FORM_TITLE;
...
public class FilmsActivity implements Activity {
    ...
    public FilmsActivity() {
        ...
        Config.TITLES.setTitle( FILMS_FORM_TITLE );
        init();
        initListeners();
    }
    ...
    private void initListeners() {
        ...
        reviewButton.addActionListener( eventListener -> {
            Main.getMainActivity().pushStackFrame( this );
            Main.getMainActivity().setNewForm( new ReviewActivity() );
        } );
